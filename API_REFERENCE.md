...
All routes live under `/api/workspaces/{workspaceId}/...` and require either a Supabase session JWT (dashboard) or a scoped API key sent as `Authorization: Bearer md_...` (public/integration use). Every response uses the envelope:
